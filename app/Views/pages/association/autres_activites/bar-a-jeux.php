<?php
$this->insert('partials/header',['titre'=>"Bar à Jeux - RevesdeJeux.com", 'description'=>"Rêves de Jeux propose des espaces de jeux animés aussi divers que variés !"]);
?>
<h1>Bar à Jeux</h1>
<section>
    <article>
        <figure>
            <img src="<?php echo $this->assetUrl("/img/autres-activites/e_bar_jeux1.jpg") ?>" alt="Un animateur présentant un jeu"></img>
    ...
    <article>
    	...
    	<ul>
    		<li>Dans une ambiance contemporaine ou spatiale : serveurs en gilet ou combinaison, espace galipettes "Station MIR" et atelier "Origami". </li>
    		<li>Ambiance moyen-âge : serveurs en costumes médiévaux, espace galipettes "Château-fort" et atelier "Escrime médiévale douce". </li>
    		<li>Ambiance amérindienne : serveurs en costumes d’indiens, espace galipettes "Tipee" et atelier "Archerie indienne".</li>
    	</ul>
    </article>
    <article>
    	<figure>
            <img src="<?php echo $this->assetUrl("/img/autres-activites/e_bar_jeux3.jpg") ?>" alt="L'animation Bar à Jeux en action"></img>
            <figcaption>Le bar à Jeux en action</figcaption>
        </figure>
        <h2>Public concerné</h2>
        <p>Animation tout public</p>
    </article>
    <article>
        <h2>Réalisations</h2>
        <p>
